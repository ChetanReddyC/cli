...
// the entry point never initialized logging. A nil result is the signal to
// skip log lines that would otherwise fall through to the process-default
// stderr logger and surface as terminal noise.
