...
// repo. Context-scoped like checkpoint's remote-list discovery, so the renderers
// can adjust their guidance without an extra positional parameter through every
// formatCheckpointOutput call site.
